...
namespace BankSystem
{
    public partial class RequestLoan : Form
    {
        ...
        public RequestLoan(int SSN) : this()
        {
            this.SSN = SSN;
        }
        ...
        private void button_requestLoan_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand.CommandText = "insert into Loan(SSN, Loan_amount, Loan_type, Branch_number, Code) values('"+SSN+"', '"+text_amount.Text+"', '"+combo_type.Text+"', '"+branch_number+"', '"+code+"')";
